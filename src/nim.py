...
import random
import time
from config import EPSILON, ALPHA, GAME_BOARD


class Nim():

    def __init__(self, initial=GAME_BOARD):
        """
...
class NimAI():
    ...
    def __init__(self, alpha=ALPHA, epsilon=EPSILON):
        """
    ...
    while True:
        ...
        if game.player == human_player:
            ...
            while True:
                ...
                count = int(input("Choose how many to remove: "))
